 ...
 */
public abstract class BaseJsParser extends Parser {
    public BaseJsParser(TokenStream input) {
        super(input);
    }
    ...
    protected boolean notOpenBraceAndNotFunction() {
        ...
        return nextTokenType != JsParser.OpenBrace && nextTokenType != JsParser.Function_;
    }

    protected boolean closeBrace() {
        return _input.LT(1).getType() == JsParser.CloseBrace;
    }
    ...
    protected boolean lineTerminatorAhead() {
        ...
        if (ahead.getType() == JsParser.LineTerminator) {
            // There is definitely a line terminator ahead.
            return true;
        }

        if (ahead.getType() == JsParser.WhiteSpaces) {
