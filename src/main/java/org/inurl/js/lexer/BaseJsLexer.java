 ...
 */
public abstract class BaseJsLexer extends Lexer {
    /**
    ...
    public BaseJsLexer(CharStream input) {
        super(input);
    }
    ...
    protected void ProcessStringLiteral() {
        if (lastToken == null || lastToken.getType() == JsLexer.OpenBrace) {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            ...
            case JsLexer.BooleanLiteral:
            case JsLexer.This:
            case JsLexer.CloseBracket:
            case JsLexer.CloseParen:
            case JsLexer.OctalIntegerLiteral:
            case JsLexer.DecimalLiteral:
            case JsLexer.HexIntegerLiteral:
            case JsLexer.StringLiteral:
            case JsLexer.PlusPlus:
            case JsLexer.MinusMinus:
